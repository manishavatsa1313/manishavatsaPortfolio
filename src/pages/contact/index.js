...
import { StyledButton, StyledTextField, StyledTypography} from '../../app/theme';
        ...
        <Grid item xs={12} sm={6} style={styles.gridItem}>
            <div style={{ margin: margin }}>
              ...
              <StyledTypography variant="h3" gutterBottom>
                ...
                <p> Email: <span style={{textDecoration: "underline"}}>{contactConfig.YOUR_EMAIL}</span></p>
                <p> {contactConfig.description}</p>
            </div>
        </Grid>
        <Grid item xs={12} sm={6} style={styles.gridItem}>
            <h2 className="centered-text">Leave a Message</h2>
            <ContactForm/>
        </Grid>
      </Grid>
      </div>
